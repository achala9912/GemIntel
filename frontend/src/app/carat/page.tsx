...
import { Upload, Scale, X } from 'lucide-react';
import {
  estimateCarat,
  fetchCaratOptions,
  type CaratResult,
...
export default function CaratPage() {
  ...
  return (
    <div className="max-width-container pt-2 sm:pt-4 pb-16 sm:pb-20">
      <header className="text-center mb-8 sm:mb-12">
        <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-2 text-white flex items-center justify-center gap-3">
          <Scale className="w-8 h-8 text-cyan-400" />
          Carat Estimation
        </h1>
        <p className="text-sm sm:text-base opacity-60 max-w-2xl mx-auto px-4 text-gray-300">
          Two photos — top and side — each with the same coin as a scale reference.
          The stone is measured in millimetres and weight is computed as
          volume &times; density. No coin, no scale: the coin is the ruler.
        </p>
      </header>

      <div className="glass-panel p-5 sm:p-8 flex flex-col gap-6 max-w-3xl mx-auto">
